...
class InputSimulator:
    ...
    CHAR_MAP = {
        ...
        "z": (e.KEY_Z, []),
        # Uppercase letters
        "A": (e.KEY_A, [e.KEY_LEFTSHIFT]),
        "B": (e.KEY_B, [e.KEY_LEFTSHIFT]),
        "C": (e.KEY_C, [e.KEY_LEFTSHIFT]),
        "D": (e.KEY_D, [e.KEY_LEFTSHIFT]),
        "E": (e.KEY_E, [e.KEY_LEFTSHIFT]),
        "F": (e.KEY_F, [e.KEY_LEFTSHIFT]),
        "G": (e.KEY_G, [e.KEY_LEFTSHIFT]),
        "H": (e.KEY_H, [e.KEY_LEFTSHIFT]),
        "I": (e.KEY_I, [e.KEY_LEFTSHIFT]),
        "J": (e.KEY_J, [e.KEY_LEFTSHIFT]),
        "K": (e.KEY_K, [e.KEY_LEFTSHIFT]),
        "L": (e.KEY_L, [e.KEY_LEFTSHIFT]),
        "M": (e.KEY_M, [e.KEY_LEFTSHIFT]),
        "N": (e.KEY_N, [e.KEY_LEFTSHIFT]),
        "O": (e.KEY_O, [e.KEY_LEFTSHIFT]),
        "P": (e.KEY_P, [e.KEY_LEFTSHIFT]),
        "Q": (e.KEY_Q, [e.KEY_LEFTSHIFT]),
        "R": (e.KEY_R, [e.KEY_LEFTSHIFT]),
        "S": (e.KEY_S, [e.KEY_LEFTSHIFT]),
        "T": (e.KEY_T, [e.KEY_LEFTSHIFT]),
        "U": (e.KEY_U, [e.KEY_LEFTSHIFT]),
        "V": (e.KEY_V, [e.KEY_LEFTSHIFT]),
        "W": (e.KEY_W, [e.KEY_LEFTSHIFT]),
        "X": (e.KEY_X, [e.KEY_LEFTSHIFT]),
        "Y": (e.KEY_Y, [e.KEY_LEFTSHIFT]),
        "Z": (e.KEY_Z, [e.KEY_LEFTSHIFT]),
        # Numbers
        "0": (e.KEY_0, []),
        "1": (e.KEY_1, []),
        "2": (e.KEY_2, []),
        ...
        "!": (e.KEY_1, [e.KEY_LEFTSHIFT]),
        "@": (e.KEY_2, [e.KEY_LEFTSHIFT]),
        "#": (e.KEY_3, [e.KEY_LEFTSHIFT]),
        "$": (e.KEY_4, [e.KEY_LEFTSHIFT]),
        "%": (e.KEY_5, [e.KEY_LEFTSHIFT]),
        "^": (e.KEY_6, [e.KEY_LEFTSHIFT]),
        "&": (e.KEY_7, [e.KEY_LEFTSHIFT]),
        "*": (e.KEY_8, [e.KEY_LEFTSHIFT]),
        "(": (e.KEY_9, [e.KEY_LEFTSHIFT]),
        ")": (e.KEY_0, [e.KEY_LEFTSHIFT]),
        # Special characters
        " ": (e.KEY_SPACE, []),
        "\n": (e.KEY_ENTER, []),
        "\t": (e.KEY_TAB, []),
    ...
    def __init__(self):
        ...
        kbd_capabilities = {e.EV_KEY: list(e.keys.keys())}
    ...
    def write(self, text, interval=0.01):
        ...
        for char in text:
            if char in self.CHAR_MAP:
                ...
                print(
                    f"Warning: Character '{char}' (U+{ord(char):04X}) not in character map"
                )
    ...
    def click(self, button="left"):
        ...
        """
        btn_map = {"left": e.BTN_LEFT, "middle": e.BTN_MIDDLE, "right": e.BTN_RIGHT}
